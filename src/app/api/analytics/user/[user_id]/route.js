...
export async function GET(req,{params}){
    try{
        ...
        const userDoc=await Users.findById(user_id,{forms_no:1,responses_no:1});
        if(!userDoc){
        ...
        return NextResponse.json({ok:true,message:"user details fetched",data:{forms_no,responses_no,total_forms}},{status:200});
    }
    catch(err){
